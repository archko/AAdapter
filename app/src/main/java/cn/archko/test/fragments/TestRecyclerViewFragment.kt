...
import cn.archko.test.adapters.BookRecyclerViewAdapter
 ...
 */
open class TestRecyclerViewFragment : Fragment() {

    private var mCurrentPath: String? = null

    protected var filesListView: RecyclerView? = null
    private var fileFilter: FileFilter? = null
    protected var fileListAdapter: BookRecyclerViewAdapter? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        this.filesListView = view.findViewById(R.id.recyclerview)
        filesListView!!.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)

        fileListAdapter = BookRecyclerViewAdapter(activity as Context, itemClickListener)
    ...
    private fun clickItem(position: Int) {
        ...
        if (clickedFile.isDirectory) {
            ...
            this@TestRecyclerViewFragment.mCurrentPath = clickedFile.absolutePath
            updateAdapter()
