...
public abstract class BaseRecyclerDiffAdapter<T> extends ListAdapter<T, BaseViewHolder> {

    protected final LayoutInflater mInflater;
    protected List<T> mData;

    public BaseRecyclerDiffAdapter(Context context) {
        this(context, null);
    }

    public BaseRecyclerDiffAdapter(Context context, List<T> data) {
    ...
    public BaseRecyclerDiffAdapter(Context context, List<T> data, DiffUtil.ItemCallback<T> callback) {
        super(callback);
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.mData = data;
        if (null == mData) {
